...
for line in data.split('\n'):
    splitArr = line.split(': ')
    splitArr1 = splitArr[0].split(' ')
    splitArr2 = splitArr1[0].split('-')
    password = splitArr[1]
    character = splitArr1[1]
    minVal = splitArr2[0]
    maxVal = splitArr2[1]
    characterOccurance = password.count(character)

    if (characterOccurance >= int(minVal) and characterOccurance <= int(maxVal)):
        count += 1
